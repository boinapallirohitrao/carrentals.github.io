    ...
    (e.prototype = {
        ...
        validateDates: function() {
            ...
            moment(this.config.startDate).isValid() &&
                ...
                null !== this.config.minDate && moment(this.config.minDate).isValid() ?
                (this.config.minDate = moment(this.config.minDate).middleOfDay()) :
                (this.config.minDate = null),
                null !== this.config.maxDate && moment(this.config.maxDate).isValid() ?
                ...
                ((a = this.config.minDate.clone()),
                    (this.config.minDate = this.config.maxDate.clone()),
                    (this.config.maxDate = a.clone()),
                    (a = null)),
                null !== this.config.minDate &&
        ...
        applyConfig: function() {
            null === this.config.target && (this.config.target = this.$elem), !1 === this.globals.isMobile ?
                (!0 === this.config.inline ?
                    ((this.container = this.$elem
                            ...
                            .parent()),
                        (this.input = a("<div class='caleran-input'></div>").appendTo(
                            this.container
                        )),
                    ...
                    this.input.css(
                        "width",
                        this.config.calendarCount * this.config.oneCalendarWidth + "px"
                    )) :
                (!0 === this.config.inline ?
                    ((this.container = this.$elem
                            .wrapAll(
        ...
        fetchInputs: function() {
            ...
            if (
                ((b = -1 !==
                        a.inArray(this.config.target.get(0).tagName, this.globals.valElements) ?
                        this.config.target.val() :
                        this.config.target.text()), !1 === this.config.singleDate &&
                    b.indexOf(this.config.dateSeparator) > 0)
            ) {
        ...
        drawUserInterface: function() {
            ...
            for (
                var a = this.globals.currentDate.clone().middleOfDay(), b = 0; b < this.config.calendarCount; b++
            )
                this.drawCalendarOfMonth(a), (a = a.add(1, "month"));
            if (
                (this.calendars
                    ...
                    this.setViewport(), !1 === this.globals.startSelected)
            )
                if (this.globals.initComplete) this.updateInput(!1);
                    ...
                    this.updateInput(!1),
                        (this.globals.delayInputUpdate = c);
                }
            this.reDrawCells();
        },
        drawHeader: function() {
            ...
            var a =
                `
                <div class=" " style=";background-color:#FF8800;margin-top:0px;border-radius:0px;padding:8px 20px 0px 20px;display:block;width:100%;position:relative;top:0px">

                <div class="form-group mb-0 radio-white-gap  trip-type-selector">
                <input name="trip-type-selector" type="radio"`;

            a += this.config.singleDate == false ? 'checked="checked"' : '';

            a += `onclick="window.changeTripType('roundtrip')" class="with-gap trip-type-round" value="roundtrip" id="radio120" >
                <label for="radio120">Roundtrip</label>
            </div>
            <div class="form-group mb-0 radio-white-gap ">
                <input name="trip-type-selector" type="radio" onclick="window.changeTripType('oneway')" class="with-gap trip-type-oneway" value="oneway" id="radio121"
                `;

            a += this.config.singleDate == true ? 'checked="checked"' : '';

            a += `>
                <label for="radio121">One way</label>
            </div>

            <div class=" form-group mb-0 checkbox-warning-filled-white white-text hidden-xs"  onclick="window.changeFlex(this)" style="float:right">
            <input type="checkbox" id="checkbox110" class="filled-in"  `;

            a += this.config.flexibleDates ? 'checked' : '';

            a += `>
            <label style="font-size:14px;" for="checkbox110">Flexible Dates</label>
        </div>
                </div>

                <div style="font-size:0.9em;border-bottom:1px solid #e0e0e0;width:100%;padding:5px 20px">
                <span style="float:left;display:block;width:50%;border :0px solid #e0e0e0">Departing on</span>`;

            a += this.config.singleDate == false ? `
                <span style="padding-left:15%;float:left;display:block;width:50%;border :0px solid #e0e0e0">Returning on</span>` : '';
            ...
            a += `
                ...
                <div class='caleran-header-start' style='clear:both'>
            ...
            !1 === this.config.singleDate &&
                (a +=
                    "<div class='caleran-header-separator'><i class='fa fa-chevron-right'></i></div><div class='caleran-header-end'><div class='caleran-header-end-day'></div><div class='caleran-header-end-date'></div><div class='caleran-header-end-weekday'></div></div>"),
                (a += "</div><div class='caleran-calendars'></div>"),
                this.input.append(a), !1 === this.config.showHeader &&
            ...
            this.config.startDate && this.config.startDate.locale(this.config.locale),
                ...
                (null !== this.config.startDate ?
                    ...
                    (this.globals.headerStartDay.text(""),
                        this.globals.headerStartDate.text(""),
                        this.globals.headerStartWeekday.text("")), !1 === this.config.singleDate &&
                    (null !== this.config.endDate ?
        ...
        isUpdateable: function() {
            ...
            return (
                ...
                (b =
                    b ||
                    (!1 === this.config.singleDate &&
                        (null === this.config.startDate || null === this.config.endDate))),
                b && this.clearInput(), !b && !a
            );
        },
            ...
            this.container.find(".caleran-title").length > 0 &&
                (this.globals.isMobile ?
                    (this.container
                        .find(".caleran-title")
                        .prepend(
                            "<div class='caleran-prev'><i class='fa fa-arrow-left'></i></div>"
                        ),
                        this.container
                        .find(".caleran-title")
                        .append(
        ...
        drawCalendarOfMonth: function(a) {
            ...
            var b = moment.localeData(this.config.locale).firstDayOfWeek(),
                ...
                .startOf("week")
                .middleOfDay();
            1 == b && !1 === this.config.startOnMonday ?
                (c.add(-1, "days"), (b = 0)) :
                0 === b &&
            ...
            this.config.enableMonthSwitcher && (f = " class='caleran-month-switch'"),
                ...
                (d +=
                    ...
                    f +
                    ">" +
                    a.locale(this.config.locale).format("MMMM") +
                    "</b>&nbsp;<span" +
                    g +
                    ">" +
                    a.year() +
            ...
            for (
                var h = moment.localeData(this.config.locale).weekdaysShort(), i = b; i < b + 7; i++
            )
                d += "<div class='caleran-dayofweek'>" + h[i % 7] + "</div>";
            for (; e < 42;) {
                var j = c.middleOfDay().unix();
                (d +=
                    "<div class='" +
                    (a.month() == c.month() ? "caleran-day" : "caleran-disabled") +
                    "' data-value='" +
                    j +
                    "'><span>" +
                    c.date() +
                    "</span></div>"),
                c.add(moment.duration({ days: 1 })),
                    e++;
            }
        ...
        drawFooter: function() {
            if (!1 === this.config.singleDate && !0 === this.config.showFooter) {
                ...
                a.append(
                    "<i class='fa fa-retweet'></i><div class='caleran-range-header'>" +
                    this.config.rangeLabel +
                    "</div>"
                );
                for (var b = 0; b < this.config.ranges.length; b++)
                    a.append(
                        "<div class='caleran-range' data-id='" +
                        b +
                        "'>" +
                        this.config.ranges[b].title +
                        "</div>"
                    );
            }
            this.globals.isMobile &&
        ...
        drawNextMonth: function(a) {
            ...
            if (
                ...
                this.globals.swipeTimeout = setTimeout(function() {
                    if (!0 ===
                        c.config.onbeforemonthchange(
                            c,
                            c.globals.currentDate.startOfMonth(),
                            "next"
                        )
                    ) {
                        var a = c.calendars.get(0).scrollTop;
                        c.globals.currentDate.middleOfDay().add(1, "month"),
                            c.reDrawCalendars(),
                            (c.calendars.get(0).scrollTop = a),
                            c.config.onaftermonthchange(
                                c,
                                c.globals.currentDate.startOfMonth()
                            );
                    }
            ...
            if (
                ...
                this.globals.swipeTimeout = setTimeout(function() {
                    if (!0 ===
                        ...
                        var a = c.calendars.get(0).scrollTop;
                        c.globals.currentDate.middleOfDay().subtract(1, "month"),
                            c.reDrawCalendars(),
                            (c.calendars.get(0).scrollTop = a),
                            c.config.onaftermonthchange(
                                c,
        ...
        cellClicked: function(c) {
            (c = c || b.event),
            (c.target = c.target || c.srcElement), !1 === a(c.target).hasClass("caleran-day") &&
                (c.target = a(c.target)
                    .closest(".caleran-day")
                    .get(0));
            ...
            if (!1 === this.config.singleDate)
                if (!1 === this.globals.startSelected) {
                    ...
                    var f =
                        void 0 === this.footer ? [] : this.footer.find(".caleran-apply");
                    f.length > 0 && f.attr("disabled", "disabled"),
                    ...
                    (this.globals.hoverDate = null), !0 ===
                        this.config.onbeforeselect(
                            this,
                            this.config.startDate,
                            this.config.endDate
                        ) && !0 === this.checkRangeContinuity() ?
                        ((this.globals.firstValueSelected = !0), this.updateInput(!0)) :
                        this.fetchInputs(),
        ...
        checkRangeContinuity: function() {
            ...
            for (
                var c = this.config.endDate.diff(this.config.startDate, "days"),
                    d = moment(this.config.startDate),
                    e = function(c) {
        ...
        cellHovered: function(c) {
            ...
            (c.target = c.target || c.srcElement), !1 === a(c.target).hasClass("caleran-day") &&
                (c.target = a(c.target)
                    ...
                    .get(0));
            var d = a(c.target).data("value");
            (this.globals.hoverDate = moment.unix(d).middleOfDay()),
            (this.globals.keyboardHoverDate = null), !0 === this.globals.startSelected && this.reDrawCells(),
                this.stopBubbling(c);
        },
        ...
        monthSwitchClicked: function() {
            if (!(this.calendars.find(".caleran-month-selector").length > 0)) {
                ...
                for (
                    var c = a("<div class='caleran-month-selector'></div>").appendTo(
                            this.calendars
                        ),
                        d = this.globals.currentDate.get("month"),
                        e = 0; e < 12; e++
                )
                    c.append(
        ...
        yearSwitchClicked: function() {
            if (!(this.calendars.find(".caleran-year-selector").length > 0)) {
                var b = this;
                this.calendars.get(0).scrollTop = 0;
                var d = a("<div class='caleran-year-selector'></div>").appendTo(
                        this.calendars
                    ),
        ...
        optimizeFontSize: function(c) {
            c.each(function(c, d) {
                ...
                if (e.innerHeight() === f.innerHeight())
                    ...
                    for (var g = 0; e.innerHeight() !== f.innerHeight() && g < 16;) {
                        ...
                        if (
                            ((h =
                                    ...
                                    parseFloat(
                                        b
                                        .getComputedStyle(f.get(0), null)
                                        .getPropertyValue("font-size")
                                    ) :
                                    parseFloat(f.css("font-size"))),
        ...
        showDropdown: function(c) {
            ...
            (c.target !== this.elem &&
                ((this.globals.dontHideOnce = !0),
                    (this.globals.initiator = c.target)),
                this.fetchInputs(),
            ...
            this.globals.initiator !== c.target &&
                ...
                (this.config.onbeforehide(this),
                    ...
                    (this.input.css({ display: "none" }),
                        a("body").removeClass("caleran-open")) :
        ...
        reDrawCells: function() {
            ...
            for (var k = 0; k < c.length; k++) {
                var l = a(c[k]),
                    ...
                    o = "caleran-day",
                    p = n.day();
                (6 != p && 0 !== p) || (o += " caleran-weekend"),
                m === j && (o += " caleran-today"),
                    (o = this.addSelectedStyles(m, o, d, e, f, g)),
                    (o = this.addHoverStyles(l, m, o, this, d, h, i)),
                    (o = this.addDisabledStyles(l, n, m, o, f, g)),
                    l.attr("class", o);
            }
        ...
        addSelectedStyles: function(a, b, c, d, e, f) {
            ...
            return (
                ...
                (!1 === g.config.singleDate &&
                    null !== c &&
                    c === a &&
                    (b += " caleran-start"), !1 === g.config.singleDate &&
                    null !== d &&
                    d === a &&
                    (b += " caleran-end"), !1 === g.config.singleDate &&
                    null !== c &&
                    null !== d &&
                    a <= d &&
                    a >= c &&
                    (b += " caleran-selected"), !0 === g.config.singleDate &&
                    null !== c &&
                    c === a &&
                    (b += " caleran-selected caleran-start caleran-end")),
                b
            );
        },
        addHoverStyles: function(a, b, c, d, e, f, g) {
            var h = this;
            return (!0 === h.globals.startSelected &&
                !1 === h.globals.endSelected &&
                null !== f &&
                ((b >= f && b <= e) || (b <= f && b >= e)) &&
                (c += " caleran-hovered"),
                1 == h.config.enableKeyboard &&
                null !== g &&
                (!1 === h.globals.startSelected ?
                    g == b &&
                    (c +=
                        " caleran-hovered caleran-hovered-first caleran-hovered-last") :
                    ((b <= e && b >= g) || (b >= e && b <= g)) &&
                    (c += " caleran-hovered")), !1 === this.lastHoverStatus &&
                c.indexOf("caleran-hovered") > 0 &&
                ((this.lastHoverStatus = !0), (c += " caleran-hovered-first")), !0 === this.lastHoverStatus &&
                c.indexOf("caleran-hovered") < 0 &&
                (a.prev(".caleran-day").addClass("caleran-hovered-last"),
                    (this.lastHoverStatus = !1)),
                c
            );
        },
        addDisabledStyles: function(b, c, d, e, f, g) {
            var h = this,
                ...
                j =
                (h.config.disabledRanges.length > 0 && i(c).length > 0) ||
                !0 === h.config.disableDays(c);
            return (
                (j || (null !== g && d > g) || (null !== f && d < f)) &&
                ((e = "caleran-disabled"), j && (e += " caleran-disabled-range")),
                c.month() != b.closest(".caleran-calendar").data("month") &&
                ((e += " caleran-disabled caleran-not-in-month"),
                    (e = e.replace("caleran-weekend", "").replace(/  /g, " "))),
                e
            );
        },
        rangeClicked: function(c) {
            ...
            if (
                ((c = c || b.event),
                    (c.target = c.target || c.srcElement),
                    c.target.hasAttribute("data-id"))
            ) {
                var d = a(c.target).attr("data-id");
                return (
                    (this.globals.currentDate = this.config.ranges[d].startDate
                        .startOf("day")
                        .clone()
                        .middleOfDay()),
                    (this.config.startDate = this.config.ranges[d].startDate
                        .startOf("day")
                        .clone()
                        .middleOfDay()),
                    (this.config.endDate = this.config.ranges[d].endDate
                        .startOf("day")
                        .clone()
                        .middleOfDay()),
                    (this.globals.firstValueSelected = !0), !1 === this.checkRangeContinuity() ?
                    this.fetchInputs() :
                    (this.config.onrangeselect(this, this.config.ranges[d]),
                        this.reDrawCalendars(),
                        this.setViewport()),
                    this.stopBubbling(c), !1
                );
            }
        },
        setViewport: function() {
            if (!0 === this.globals.isMobile)
                ...
                switch (this.config.showOn) {
                    case "top":
                        return this.config.autoAlign ?
                            this.positionOnTopAlign() :
                            this.positionOnTop();
                    case "left":
                        return this.config.autoAlign ?
                            this.positionOnLeftAlign() :
                            this.positionOnLeft();
                    case "right":
                        return this.config.autoAlign ?
                            this.positionOnRightAlign() :
                            this.positionOnRight();
                    case "bottom":
                    default:
                        return this.config.autoAlign ?
                            this.positionOnBottomAlign() :
        ...
        positionOnRight: function(a) {
            var b = this.getDimensions(this.$elem, !0),
                c = (this.getDimensions(this.container, !0),
                    parseInt(this.input.css("margin-left"), 10)),
        ...
        getDimensions: function(a, e) {
            var f = c,
                ...
                g.pageXOffset !== d ?
                g.pageXOffset :
                (f.documentElement || h.parentNode || h).scrollLeft,
                k =
                g.pageYOffset !== d ?
                g.pageYOffset :
                (f.documentElement || h.parentNode || h).scrollTop,
                l = i.getBoundingClientRect();
            if (i !== h)
                for (var m = i.parentNode; m !== h && null !== m;)
                    (j += m.scrollLeft), (k += m.scrollTop), (m = m.parentNode);
            return {
                width: l.width,
                height: l.height,
                offsetTop: l.top + k,
        ...
        attachEvents: function() {
            ...
            if (
                (this.container
                    ...
                    .off(i)
                    .on(i, h), !0 === this.globals.isMobile)
            )
                if ("function" == typeof a.fn.swiperight)
                    this.input.find(".caleran-calendars").css("touch-action", "none"),
                    this.input.find(".caleran-calendars").on("swipeleft", b),
                    this.input.find(".caleran-calendars").on("swiperight", c);
                else {
                    var j = new Hammer(this.input.find(".caleran-calendars").get(0));
                    j.off("swipeleft").on("swipeleft", b),
                        j.off("swiperight").on("swiperight", c);
                }
        ...
        addInitialEvents: function() {
            ...
            (this.globals.documentEvent =
                d + "_" + Math.round(new Date().getTime() + 100 * Math.random())),
            a(c).on(
                    this.globals.documentEvent,
                    a.proxy(function(c) {
                        !1 === this.globals.isMobile &&
                            ...
                            ((c = c || b.event),
                                (c.target = c.target || c.srcElement),
                                0 === a(this.container).find(a(c.target)).length &&
                                this.elem !== c.target &&
                                this.input.get(0).clientHeight > 0 &&
                                this.hideDropdown(c));
                    }, this)
                ),
                this.config.enableKeyboard && (d = "click.caleran focus.caleran"),
                this.$elem.off(d).on(
                    d,
                    a.proxy(
                        this.debounce(
                            function(a) {
                                ...
                                (a.target = a.target || a.srcElement),
                                this.input.get(0).clientHeight > 0 &&
                                    this.config.target.get(0) !== a.target ?
                                    this.hideDropdown(a) :
                                    this.showDropdown(a);
                            },
                            200, !0
                ...
                this.container.on(
                    ...
                    a.proxy(function() {
                        var c = this.input
                            ...
                            .innerHeight();
                        this.input.find(".caleran-calendars").css("height", c),
                            this.input.position().top < 0 &&
                            this.input.addClass("caleran-input-top-reset"),
                            a(b).width() > a(b).height() ?
                            "none" !== this.input.css("display") &&
                            this.input.css("height", c + "px") :
                ...
                a(b).on(
                    "resize scroll",
                    a.proxy(this.debounce(this.setViewport, 200, !1), this)
                );
        },
        stopBubbling: function(a) {
            void 0 !== a.stopPropagation ?
                a.stopPropagation() :
                void 0 !== a.cancelBubble && (a.cancelBubble = !0),
        ...
        debounce: function(a, b, c) {
            return function() {
                ...
                clearTimeout(d.globals.throttleTimeout),
                    (d.globals.throttleTimeout = setTimeout(f, b)),
                    g && a.apply(d, e);
            };
        },
                ...
                var b = a.proxy(function(a) {
                    ...
                    if (c || d)
                        return (
                            ...
                            d && this.stopBubbling(a), !1
                        );
                }, this);
                this.$elem.off("keydown.caleran").on("keydown.caleran", b),
                    this.container.off("keydown.caleran").on("keydown.caleran", b);
            }
        },
        destroy: function() {
            this.config.inline ?
        ...
        checkMobile: function() {
            return (
                ...
                /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(
                    (navigator.userAgent || navigator.vendor || b.opera).substr(0, 4)
                )
            );
        },
        setStart: function(a) {
            !1 === this.isDisabled(a) &&
                moment(a).isValid() &&
                ((this.config.startDate = moment(a)), this.refreshValues());
        },
        setEnd: function(a) {
            !1 === this.isDisabled(a) &&
                moment(a).isValid() &&
                ((this.config.endDate = moment(a)), this.refreshValues());
        },
        setMinDate: function(a) {
            moment(a).isValid() &&
                ((this.config.minDate = moment(a)), this.refreshValues());
        },
        setMaxDate: function(a) {
            moment(a).isValid() &&
                ((this.config.maxDate = moment(a)), this.refreshValues());
        },
        setDisplayDate: function(a) {
            moment(a).isValid() &&
                ((this.globals.currentDate = moment(a)), this.reDrawCalendars());
        },
